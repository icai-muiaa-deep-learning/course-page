...
![Real Neuron](images/real_neuron.png)
...
<img src="images/linear_layer_equation.png" alt="drawing"/>

</div>

<div>

<img src="images/linear_layer.png" alt="drawing" width="80%"/>
...
inputs: torch.Tensor = torch.rand((64, 40))
layer = torch.nn.Linear(40, 10)
